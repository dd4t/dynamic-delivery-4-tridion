 ...
 * 
 */
public class DefaultBrokerCacheAgent implements CacheAgent {


	private static Logger logger = Logger
			.getLogger(DefaultBrokerCacheAgent.class);
	...
	public void storeInCache(String key, Object ob, com.tridion.storage.PageMeta pageMeta) {
		...
		if (ob instanceof Cachable) {
	        ...
	        cache.addDependency(key, ITEM_CACHE_REGION,
                        KeyGenerator.createKey(pageMeta.getPublicationId(), pageMeta.getItemId()));
	}

...
<%@page import="com.tridion.extensions.dynamicdelivery.foundation.contentmodel.GenericPage"%>
...
<%
	...
	GenericPage pageModel = (GenericPage) request.getAttribute(Constants.PAGE_MODEL_KEY);
%>

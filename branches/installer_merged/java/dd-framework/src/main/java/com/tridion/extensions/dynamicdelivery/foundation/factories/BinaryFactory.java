...
public interface BinaryFactory extends Factory {
	 ...
	 */
	public Binary getBinary(String uri, RequestContext context) throws ItemNotFoundException, NotAuthorizedException, StorageException, ParseException;
	 ...
	 * @throws StorageException 
	 */
	public Binary findBinaryByUrl(String url, int publicationId, RequestContext context) throws ItemNotFoundException, NotAuthorizedException, StorageException, ParseException;

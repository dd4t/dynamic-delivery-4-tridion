...
namespace DD4T.Examples.ResourceManagement.DynamicResourceProviderFactory
{
    ...
    public class DynamicResourceProvider : IResourceProvider
    {
        ...
        public ICacheAgent CacheAgent 
        {
            get
            {
                if (_cacheAgent == null)
                {
                    _cacheAgent = UnityHelper.Container.Resolve<ICacheAgent>();
                }
                return _cacheAgent;
            }
        }
        ...
        private IPageFactory PageFactory
        {
            get
            {
                ...
                {
                    _pageFactory = UnityHelper.Container.Resolve<IPageFactory>();
                }
                return _pageFactory;
            }
        }

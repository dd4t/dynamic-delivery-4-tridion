...
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.CategoryImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.ComponentLinkField;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.ComponentPresentationImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.ComponentTemplateImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.DateField;
...
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.GenericPageImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.KeywordImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.MultimediaImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.NumericField;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.OrganizationalItemImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.PageTemplateImpl;
...
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.StructureGroupImpl;
import com.tridion.extensions.dynamicdelivery.foundation.contentmodel.impl.TextField;
...
public class GenericConverter implements Converter<Object> {
	...
	public Object read(InputNode node) throws Exception {
		...
		if("publication".equals(name)){
			...
			object = (GenericPageImpl) serializer.deserialize(node, GenericPageImpl.class);			
		}
